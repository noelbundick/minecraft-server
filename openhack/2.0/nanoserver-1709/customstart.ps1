...
Start-Job -ScriptBlock {
  while(!(Test-Path C:\minecraft\minecraft.out) -or (Select-String -Pattern 'RCON running' -Path C:\minecraft\minecraft.out) -eq $null) { Write-Output "nothing"; Start-Sleep -Seconds 1 }
